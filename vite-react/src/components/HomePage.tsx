      ...
      <aside className="flex w-full flex-col gap-4 md:col-span-2">
        ...
        <footer className="flex flex-wrap items-center justify-center gap-[24px]">
          <a
            ...
            href="https://c15t.com/docs/frameworks/react/quickstart?utm_source=vite-react-example&utm_medium=referral&utm_campaign=view-docs&utm_content=docs-link"
            target="_blank"
          ...
          <a
            className="flex items-center gap-2 hover:underline hover:underline-offset-4"
            href="https://github.com/c15t/examples/tree/main?utm_source=vite-react-example&utm_medium=referral&utm_campaign=view-on-github&utm_content="
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            className="flex items-center gap-2 hover:underline hover:underline-offset-4"
            href="https://consent.io?utm_source=vite-react-example&utm_medium=referral&utm_campaign=visit-hosted&utm_content=hosted-link"
            target="_blank"
            rel="noopener noreferrer"
          >
